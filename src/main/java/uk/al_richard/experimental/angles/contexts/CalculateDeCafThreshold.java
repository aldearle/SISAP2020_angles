...
public class CalculateDeCafThreshold extends DeCafContext {

    public CalculateDeCafThreshold() throws IOException, ClassNotFoundException {
    }
    ...
    private void findThresh() throws IOException, ClassNotFoundException {
        ...
        for( int query_index = 0; query_index < 100; query_index ++ ) {
            double query_radius = refine(data, start, query_index, 1.0);
    ...
    public static void main(String[] args) throws Exception {
        CalculateDeCafThreshold dcth = new CalculateDeCafThreshold();
        dcth.setSizes(1000000, 0, 0 );
        dcth.findThresh();
    }
