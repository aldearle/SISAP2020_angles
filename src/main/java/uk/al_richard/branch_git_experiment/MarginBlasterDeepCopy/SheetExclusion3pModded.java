...
public class SheetExclusion3pModded<T> extends SheetExclusionModded<T> {
	...
	public SheetExclusion3pModded(RefPointSet<T> pointSet, int ref1, int ref2) {
	...
	public SheetExclusion3pModded(RefPointSet<T> pointSet, int ref1, int ref2, double sheet_offset) {
	...
	public boolean mustBeOutMargin(double[] dists, double t, double m) {
		return (dists[this.getRef1()] - dists[this.getRef2()]) - this.getOffset() >= (2 * (t-m));
	}
