 ...
 */
public class SheetExclusion4pModded<T> extends SheetExclusionModded<T> {
	...
	public SheetExclusion4pModded(RefPointSet<T> pointSet, int ref1, int ref2) {
	...
	public SheetExclusion4pModded(RefPointSet<T> pointSet, int ref1, int ref2, double offset ) {
	...
	public boolean mustBeInMargin(double[] dists, double t, double m ) {
		double x_offset = getXOffset(dists);
		return x_offset < this.offset - t + m;
	}
