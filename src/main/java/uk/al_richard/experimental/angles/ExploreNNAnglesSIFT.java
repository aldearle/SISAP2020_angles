...
public class ExploreNNAnglesSIFT extends CommonBase {
    ...
    private void explore() {
        ...
        CartesianPoint origin = new CartesianPoint( makePoint(0) );
        ...
        for( int index : nn_map.keySet() ) {
            ...
            for( int nn_index = 0; nn_index < nn_ids.length; nn_index++) {
                ...
                if( index != next_nn_data_index ) {
                    ...
                    calculateAngle(origin, pivot, query, d_pivot_q);
                }
            }
        }
        printDists();
    ...
    public static void main( String[] args ) throws Exception {
        ...
        ExploreNNAnglesSIFT ea = new ExploreNNAnglesSIFT( SIFT, 1000, 1000, false );
        ea.explore();
    }
}
